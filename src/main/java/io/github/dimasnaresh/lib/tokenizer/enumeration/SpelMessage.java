package io.github.dimasnaresh.lib.tokenizer.enumeration;
...
public enum SpelMessage {
    ...
    private final SpelMessage.Kind kind;
    private final int code;
    private final String message;

    private SpelMessage(SpelMessage.Kind kind, int code, String message) {
        this.kind = kind;
        this.code = code;
